...
return response()->json(['data' => $data, 'success' => true, 'messages' => []]);
  ...
  public function getFishing_report_full(Request $request){
    ...
    return $e->getMessage();
        ...
        //   $user=DB::table('customer_registration')->where('customer_id','=',$uid)->get();
        ...
        //     $data['order_id']=$or_id;
        //     $data['customer']=DB::table('customer_registration')->where('customer_id','=',$uid)->first();
