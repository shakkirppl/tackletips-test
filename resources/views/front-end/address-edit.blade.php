               ...
               <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                     <div class="shipping-address">
                        ...
                        <form class="form-sub" action="{{ url('update.shipping-address') }}" id="billingForm" method="POST">
                           @csrf
                           <input type="hidden" name="id" value="{{$customerAddress->id}}">
                           <input type="hidden" name="mode" value="{{$mode}}">
                           <div class="form-group mb-3">
                              <label>Name <sup>*</sup></label>
                              <input class="form-control" name="customer_name" type="text" value="{{$customerAddress->customer_name}}">
                              @error('customer_name')
                           ...
                           <div class="form-group mb-3">
                              ...
                              <textarea class="form-control" name="customer_address"> {{$customerAddress->customer_address}}</textarea>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group mb-3 ">
                                    ...
                                    <input class="form-control" name="customer_city" type="text" value="{{$customerAddress->customer_city}}">
                                    @error('customer_city')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                 </div>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group mb-3 ps-2">
                                    ...
                                    <input class="form-control" name="customer_pincode" type="text" value="{{$customerAddress->customer_pincode}}">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" name="customer_mobile" type="text" value="{{$customerAddress->customer_mobile}}">
                                 ...
                                 <div class="form-group mb-3 ps-2">
                                    ...
                                    <div class="btn-group bootstrap-select">
                                       <select class="selectpicker checkout-selector" name="customer_state"
                                          ...
                                          @if($stat->id==$customerAddress->customer_state)
                                 ...
                                 <div class="form-group mb-3 ">
                                    ...
                                    <div class="btn-group bootstrap-select">
                                       <select class="selectpicker checkout-selector" name="customer_dist"
                                          ...
                                          @if($distr->id==$customerAddress->customer_dist)
                                          <option selected value="{{$distr->id}}">{{$distr->name}}</option>
                                          @else
