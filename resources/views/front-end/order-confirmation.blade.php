                              ...
                              <div class="order-confirmation">
                                 <div class="image-order">
                                    ...
                                    <div class="image-order-sub">
                                       <img src="{{URL::to('/')}}/front-end/images/order/sucess.png" alt="Sample Image">
                                    </div>
                                 </div>
                                 <h1 class="head-first">THANK YOU FOR YOUR PURCHASE</h1>
                                 <p class="head-second">We have Received</p>
                                 <p class="head-three">Your Order Number Is <span style="font-weight: 800; color:#d7ce3b;"> {{$orders->order_number}}</span></p>
                              </div>
                           </div>
                           <div class="col-md-12">
                              <div class="row">
                                 <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-end pe-2">
                                    <a href="{{url('my-order')}}"><button class="button-58 view-order-confirmation">VIEW ORDER</button></a>
                                 </div>
                                 <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-start">
                                    <a href="{{URL::to('/')}}"><button class=" button-58 confirmation-shopping">CONTINUE SHOPPING</button></a>
                                 </div>
                              </div>
                           </div>
                        </div>
