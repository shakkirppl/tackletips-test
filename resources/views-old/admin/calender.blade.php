...
@section('style')
 <!-- Vendor styles -->
        ...
        <link rel="stylesheet" href="{{url('assets/vendors/bower_components/sweetalert2/dist/sweetalert2.min.css')}}">
...
@section('script')
 ...
 <!-- Vendors -->
        ...
        <script src="{{url('assets/vendors/bower_components/sweetalert2/dist/sweetalert2.min.js')}}"></script>
