                         ...
                         <form action="{{url('update-brands')}}" method="post" enctype="multipart/form-data">
                           ...
                           {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="brand_id" value="{{ $ed_brand->id}}">

                                <input type="text" name="brand_name" placeholder="Enter Brand name" class="form-control" value="{{ $ed_brand->name}}" required="">
