 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('update-unit')}}" method="post" enctype="multipart/form-data">
                            @foreach($ed_unit as $unit)
                           {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="unit" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Unit Name" value="{{ $unit->name}}">
