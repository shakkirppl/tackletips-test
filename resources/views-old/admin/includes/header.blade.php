            <header class="header">
                ...
                <div class="header__logo hidden-sm-down">
                    <h1><a href="{{url('admin/dash-board')}}">Dashboard</a></h1>
                </div>
                ...
                <ul class="top-nav">
                    ...
                    <li class="dropdown top-nav__notifications" style="display: none;">
                    ...
                    <li class="dropdown hidden-xs-down" style="display: none;">
                    ...
                    <li class="dropdown hidden-xs-down">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu--block" role="menu">
                            <div class="row app-shortcuts">
                                <a class="col-4 app-shortcuts__item" href="{{url('/calender')}}">
                                    <i class="zmdi zmdi-calendar"></i>
                                    <small class="">Calendar</small>
                                    <span class="app-shortcuts__helper bg-red"></span>
                                </a>
                                <a class="col-4 app-shortcuts__item" href="{{ url('/ad_orders') }}">
                                    <i class="zmdi zmdi-file-text"></i>
                                    <small class="">Orders</small>
                                    <span class="app-shortcuts__helper bg-blue"></span>
                                </a>
                                <a class="col-4 app-shortcuts__item" href="{{ url('/ad_purchase') }}">
                                    <i class="zmdi zmdi-email"></i>
                                    <small class="">Purchase</small>
                                    <span class="app-shortcuts__helper bg-teal"></span>
                                </a>
                                <a class="col-4 app-shortcuts__item" href="{{ url('/ad_customers')}}">
                                    <i class="zmdi zmdi-trending-up"></i>
                                    <small class="">Customers</small>
                                    <span class="app-shortcuts__helper bg-blue-grey"></span>
                                </a>
                                <a class="col-4 app-shortcuts__item" href="{{url('/products')}}">
                                    <i class="zmdi zmdi-view-headline"></i>
                                    <small class="">Products</small>
                                    <span class="app-shortcuts__helper bg-orange"></span>
                                </a>
                                <a class="col-4 app-shortcuts__item" href="{{url('category/categories')}}">
                    ...
                    <li class="hidden-xs-down" style="display: none;">
