...
<span class="icons_head"><a href="{{url('/add-slider-images')}}" class="btn btn-primary btn--icon"><i class="zmdi zmdi-plus" style="padding-top: 11px;"></i></a>
                        <a href="{{url('/add-slider-images')}}" class="btn btn-danger btn--icon"><i class="zmdi zmdi-delete" style="padding-top: 11px;"></i></a>
                        </span><br>
                            ...
                            <table id="data-table" class="table table-bordered">
                                ...
                                @foreach($slider as $sliders)
                                    <tr> 
                                        ...
                                        <td><img src="{{url('/uploads/home-slider/'.$sliders->img_name) }}" alt="" width="100px" ></td>
                <td><a href="{{ url('delete-slider-image/'.$sliders->img_id) }}""  onclick="return confirm('Are you sure you want to delete');" class="btn btn-light btn--icon"><i class="zmdi zmdi-delete zmdi-hc-fw"></i></a></td>
                                    </tr>
