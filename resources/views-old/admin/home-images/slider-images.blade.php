...
<h1>Add Home Slider image --Web ( 1388 x 400 ) ----- App ( 708 x 369 ) </h1>
                        <div class="actions">
 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('/add-slider-img')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
                                <select class="form-control" name="url" required="">
                                    ...
                                    <option value="{{$productss->product_id}}">{{$productss->name}}</option>
                                    @endforeach
                                </select>
        </div>
