...
<span class="icons_head"><a href="{{url('/admin/add-testimonial')}}" class="btn btn-primary btn--icon"><i class="zmdi zmdi-plus" style="padding-top: 11px;"></i></a>
                        <a href="{{url('/admin/add-testimonial')}}" class="btn btn-danger btn--icon"><i class="zmdi zmdi-delete" style="padding-top: 11px;"></i></a>
                        </span><br>
                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $blog->testimonial_author }}</td>
                                    <td>{{ $blog->testimonial_category }}</td>
                                <td>{{ $blog->testimonial_desc }}</td>
                              

                                        <td>
                                             

                                        <a href="{{url('delete-testimonial/'.$blog->testimonial_id )}}"  onclick="return confirm('Are you sure you want to delete');" class="btn btn-light btn--icon"><i class="zmdi zmdi-delete zmdi-hc-fw"></i></a></td>
                                    </tr>
                                    @endforeach
