...
<span class="icons_head"><a href="{{url('category/add-categories')}}" class="btn btn-primary btn--icon"><i class="zmdi zmdi-plus" style="padding-top: 11px;"></i></a>
                        <a href="{{url('category/add-categories')}}" class="btn btn-danger btn--icon"><i class="zmdi zmdi-delete" style="padding-top: 11px;"></i></a>
                        </span><br>
...
<?php $i='0'; ?>
                                    ...
                                    <tr>
                                       ...
                                       @foreach($parent as $parent)
                                           ...
                                           <td>{{$parent->name}}->{{$category->name}}</td>
                                         @endforeach
                                        ...
                                        <td><a href="{{url('edit-category/'.$category->id)}}" class="btn btn-light btn--icon"><i class="zmdi zmdi-edit zmdi-hc-fw"></i></a>

                                        <a href="{{url('delete-category/'.$category->id)}}"  onclick="return confirm('Are you sure you want to delete');" class="btn btn-light btn--icon"><i class="zmdi zmdi-delete zmdi-hc-fw"></i></a></td>
                                    </tr>
                                    @endforeach
