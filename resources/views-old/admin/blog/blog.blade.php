...
<span class="icons_head"><a href="{{url('/admin/add-blog')}}" class="btn btn-primary btn--icon"><i class="zmdi zmdi-plus" style="padding-top: 11px;"></i></a>
                        <a href="{{url('/admin/add-blog')}}" class="btn btn-danger btn--icon"><i class="zmdi zmdi-delete" style="padding-top: 11px;"></i></a>
                        </span><br>
                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $blog->blog_cat_name }}</td>
                                <td>{{ $blog->blog_posted_by }}</td>
                                 <td> <img src="{{url('/uploads/blogs/'.$blog->blog_image) }}" width="150px" height="100px"></td>

                                        <td>
                                             <a href="{{url('view-blog/'.$blog->id)}}" class="btn btn-light btn--icon"><i class="zmdi zmdi-eye zmdi-hc-fw"></i></a>
                                            <a href="{{url('adm-edit-blog/'.$blog->id)}}" class="btn btn-light btn--icon"><i class="zmdi zmdi-edit zmdi-hc-fw"></i></a>

                                        <a href="{{url('delete-blog/'.$blog->id)}}"  onclick="return confirm('Are you sure you want to delete');" class="btn btn-light btn--icon"><i class="zmdi zmdi-delete zmdi-hc-fw"></i></a></td>
                                    </tr>
                                    @endforeach
