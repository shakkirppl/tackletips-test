...
var offer= $('#offer_product').val();
            if (offer==0) {
                $('#product_price_offer').val($('#product_price').val());
            }
            else{
               $('#product_price_offer').val('');
            }
        });
         ...
         $('#offer_product').change(function() {
            var offer = $(this).val();
            if(offer==1){
 document.getElementById('product_price_offer').removeAttribute('readonly');
  $('#product_price_offer').val('');
}
else{
  document.getElementById('product_price_offer').readOnly = true;
  $('#product_price_offer').val($('#product_price').val());
}
            // $('#items').html(items());
        });
...
<h1>Add Product</h1>
 ...
 <!-- arabic end -->
          ...
          @endif
                         ...
                         <form action="{{url('/add-new-product')}}" method="post" enctype="multipart/form-data" id="theform">
                          ...
                          <div class="col-md-12">
                           ...
                           <div class="col-md-12">
                             <div class="form-group">
                                ...
                                <input type="text"  name="min_stock" class="form-control"  value="0" >
                                <i class="form-group__bar"></i>
                            </div>
                          </div>
                           <div class="col-md-12">
                             <div class="form-group">
                                ...
                                <input type="text"  name="max_stock" class="form-control" value="0"  >
                                <i class="form-group__bar"></i>
                            </div>
                          </div>
                           ...
                           <div class="col-md-12">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="number" name="net_rate" id="net_rate" class="form-control"   required="" value="0">
                                <i class="form-group__bar"></i>
                            </div>
                            </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" name="mrp_price" id="mrp_price" class="form-control"   required="" value="0">
                                <i class="form-group__bar"></i>
                              </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" name="wholesale_rate" id="wholesale_rate" class="form-control"   required="" value="0">
                                <i class="form-group__bar"></i>
                            </div>
                            </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" name="quotation_price" id="quotation_price" class="form-control"   required="" value="0">
                                <i class="form-group__bar"></i>
                              </div>
                            </div>
