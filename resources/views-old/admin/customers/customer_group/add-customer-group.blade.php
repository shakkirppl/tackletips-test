 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('/add-new-cust-group')}}" method="post" enctype="multipart/form-data">
                           ...
                           {{csrf_field()}}
                            ...
                            <div class="form-group">
                              <label>Description</label>
                                <textarea class="form-control" name="group_desc" placeholder="Description"></textarea>
                                <i class="form-group__bar"></i>
                            </div>
