 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('/update-cust-group')}}" method="post" enctype="multipart/form-data">
                            @foreach($edit_cust as $edit_cust)
                           {{csrf_field()}}

                             <div class="form-group">
                              <label>Group Name</label>
                                <input type="hidden" name="group_id" value="{{ $edit_cust->group_id}}">

                                <input type="text" name="group_name" value="{{ $edit_cust->group_name}}" class="form-control" placeholder="Group Name" required="" data-toggle="tooltip" title="Group Name">
                            ...
                            <div class="form-group">
                              <label>Description</label>
                                <textarea class="form-control" name="group_desc" placeholder="Description" data-toggle="tooltip" title="Description">{{ $edit_cust->group_desc}}</textarea>
                                <i class="form-group__bar"></i>
                            </div>
