...
<span class="icons_head"><a href="{{url('/add-customer-group')}}" class="btn btn-primary btn--icon"><i class="zmdi zmdi-plus" style="padding-top: 11px;"></i></a>
                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach($cust_groups as $cust_groups)
                                    <tr>

                                        <td>{{ $cust_groups->group_name}}</td>
                                        <td>{{ $cust_groups->group_desc}}</td>
                                       

                                       

                                        <td><a href="{{url('edit-cust-group/'.$cust_groups->group_id)}}" class="btn btn-light btn--icon" ><i class="zmdi zmdi-edit zmdi-hc-fw"></i></a>

                                        <a href="{{url('delete-cust-group/'.$cust_groups->group_id) }}" class="btn btn-light btn--icon" onclick="return confirm('Are you sure you want to delete this User');"><i class="zmdi zmdi-delete zmdi-hc-fw" ></i></a></td>
                                    </tr>
                                    @endforeach
