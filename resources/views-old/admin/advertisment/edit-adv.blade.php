 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('update-ads')}}" method="post" enctype="multipart/form-data">
                            @foreach($ed_ads as $ed_ads)
                           {{csrf_field()}}

                            <div class="form-group">
                              <label>Image Url</label>
                                <input type="hidden" name="add_id" value="{{ $ed_ads->add_id}}">
                                <input type="url" name="add_page" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Ads title" value="{{ $ed_ads->page}}">
                            ...
                            <div class="form-group">
                              <label>Advertising Image (IN THE SPOTLIGHT)</label>
                                <input type="file" name="image" id="dropzone-upload" class="dropzone dz-clickable" data-toggle="tooltip" title="Image" value="{{ $ed_ads->image}}">
                                 <span><img src="{{url('/uploads/ads/'.$ed_ads->image) }}" alt="" width="150px" height="100px"></span>
                                <i class="form-group__bar"></i>
                            </div>
