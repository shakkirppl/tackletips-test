 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('update-attributes')}}" method="post" enctype="multipart/form-data">
                            @foreach($attributes as $attributes)
                           {{csrf_field()}}

                            <div class="form-group">
                                <label>Attribute Name</label>
                                <input type="hidden" name="attr_id" value="{{ $attributes->attribute_id}}">
                                <input type="text" name="attr_name" class="form-control" data-toggle="tooltip" data-placement="bottom" title="Category Name" value="{{ $attributes->attribute_name}}">
