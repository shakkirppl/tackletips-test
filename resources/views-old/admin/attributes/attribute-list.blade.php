...
<span class="icons_head"><a href="{{url('/add-attribute')}}" class="btn btn-primary btn--icon"><i class="zmdi zmdi-plus" style="padding-top: 11px;"></i></a>
                        <a href="{{url('/add-attribute')}}" class="btn btn-danger btn--icon"><i class="zmdi zmdi-delete" style="padding-top: 11px;"></i></a>
                        </span><br>
...
<h5>Attribute List</h5>
                        <div class="table-responsive">
                            <table id="data-table" class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $i='0'; foreach ($attributes as $attributes) { $i++; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{url('edit-attributes/'.$attributes->attribute_id)}}" class="btn btn-light btn--icon"><i class="zmdi zmdi-edit zmdi-hc-fw"></i></a>

                                        <a href="{{url('delete-attributes/'.$attributes->attribute_id)}}"  onclick="return confirm('Are you sure you want to delete');" class="btn btn-light btn--icon"><i class="zmdi zmdi-delete zmdi-hc-fw"></i></a></td>
                                    </tr>
                                    <?php } ?>
