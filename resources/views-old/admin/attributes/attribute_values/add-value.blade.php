 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('add-new-value')}}" method="post" enctype="multipart/form-data">
                           ...
                           {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="attr_val" placeholder="Enter the value" class="form-control"  required="">
                                <i class="form-group__bar"></i>
                            </div>
                            ...
                            <div style="display: none;" id="inp_hiden">
                              <div class="form-group">
                                <label>Enter a Hexcode (Example:#e6194b for color Red.)</label>
                                  <input type="text"  name="hex_val" placeholder="Enter corresponding Hexcode" class="form-control">
                                <i class="form-group__bar"></i>
                              </div>
                            </div>
