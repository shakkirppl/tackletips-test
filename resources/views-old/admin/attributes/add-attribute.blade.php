 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('add-new-attribute')}}" method="post" enctype="multipart/form-data">

                           {{csrf_field()}}

                            <div class="form-group">
                                <label>Attribute Name</label>
                                <input type="text" name="attr_name" placeholder="Enter an Attribute name" class="form-control"  required="">
