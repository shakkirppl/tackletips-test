...
<span class="icons_head"><a href="{{url('/admin/add-deal')}}" class="btn btn-primary btn--icon"><i class="zmdi zmdi-plus" style="padding-top: 11px;"></i></a>
                        <a href="{{url('/admin/add-deal')}}" class="btn btn-danger btn--icon"><i class="zmdi zmdi-delete" style="padding-top: 11px;"></i></a>
                        </span><br>
                        ...
                        <div class="table-responsive">
                            <table id="data-table" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <td>{{ $daily_deal->name}}</td>
                                    
                              
                                        <td>
                                           

                                        <a href="{{url('delete-daily-deal/'.$daily_deal->id)}}"  onclick="return confirm('Are you sure you want to delete');" class="btn btn-light btn--icon"><i class="zmdi zmdi-delete zmdi-hc-fw"></i></a></td>
                                    </tr>
                                    @endforeach
