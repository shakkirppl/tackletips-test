 ...
 <!-- arabic end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                         ...
                         <form action="{{url('/add-new-images')}}" method="post" enctype="multipart/form-data">
                           ...
                           <div class="row">
                                   ...
                                   <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 select2-hidden-accessible" multiple="" data-placeholder="Select a product" name="product_name" tabindex="-1" aria-hidden="true" style="border:none;" required="">
        ...
        <div class="form-group field_wrapper">
            <label>Product Images</label><br>
                ...
                <a href="javascript:void(0);" class="add_button dropzone dz-clickable" title="Add field"><img src="{{url('uploads/add-icon.png')}}"/></a>
