...
<head>
    ...
    <title>Payment Failed - Fishing Tackle Store</title>
                ...
                <div class="col-lg-12">
                    <div class="ttm-page-title-row-inner">
                        <div class="page-title-heading">
                            <h2 class="title text-danger">Payment Failed</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="questions-box text-center" style="margin-top:0px !important">
                    ...
                    <p class="lead">Your payment could not be completed. Please try again or contact our support team for assistance.</p>
                    <a href="{{ url('/') }}" class="btn btn-danger m-2">Return to Home</a>
                    <!-- <a href="{{ url('contact') }}" class="btn btn-secondary m-2">Contact Support</a> -->
                </div>
            </div>
        </div>
    </div>
