...
<h4 class="post-title"><a href="#">{{$first->blog_title}}</a></h4>
<div class="meta">
<span class="meta-part"><a href="#"><i class="icon-user"></i> {{$first->blog_posted_by}}</a></span>
<span class="meta-part"><a href="#"><i class="icon-speech"></i> 245 Coments</a></span>
<span class="meta-part"><a href="#"><i class="icon-calendar"></i>{{$first->created_at}}</a></span>
</div>
<p>{!!$first->blog_desc!!}</p>
